...
public:
    ...
    //更新
    Vector3 Update(bool huntFlag,Vector3 playerPos);
...
private:
    ...
    //ゴールに辿り着いた時の処理
    void SetGoalProcess(const bool huntFlag,const Vector3 playerPos);

    //距離を計算
    float QueryCost(SharedNode n1, SharedNode n2);
